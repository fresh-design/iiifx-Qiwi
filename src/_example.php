...
$qiwiPaymentRequest = new \iiifx\Qiwi\PaymentRequest( $shopId, $apiId, $apiPassword );
...
$qiwiPaymentRequest
    ...
    ->setLifetimeSeconds( \iiifx\Qiwi\PaymentRequest::LifetimeSeconds_OneDay ) # Время жизни счета, в секундах
    ->setPaymentType( \iiifx\Qiwi\PaymentRequest::PaymentType_Any ) # Тип оплаты
    ->setShopName( 'WePlay' );
...
$qiwiCheckRequest = new \iiifx\Qiwi\CheckRequest( $shopId, $apiId, $apiPassword );
